...
param_grid = {
    'C': [10**x for x in np.arange(-5, 1.1, 0.5)]  # Regularization parameter values to try
}

log_reg = LogisticRegression(max_iter=100)  # Initializing logistic regression model
...
# Save best model
with open('models/MouseBrain_LogReg.pkl', 'wb') as f:
